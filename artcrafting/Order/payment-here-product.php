...
$obj->initOrder("$order_id", "$product_name", "$total_price", 'http://127.0.0.1/artcrafting/Order/order-success.php/', 'http://127.0.0.1/artcrafting/Order/order-failed.php', 'INR');
